...
public class CodeMsg {
	...
	// 登录模块异常 5002XX
	public static CodeMsg SESSION_ERROR = new CodeMsg(500200,
			"Session不存在或者已经失效");
	public static CodeMsg INPUTPASS_EMPTY = new CodeMsg(500201, "登录密码不能为空");
	...
	public static CodeMsg MIAOSHA_REPEAT = new CodeMsg(500501, "重复秒杀");
